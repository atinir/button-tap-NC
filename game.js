...
var vulgs = ["YOU SUCK! ", "WTF was that?? ", "My Grandmother plays better than you.", "Boon is a bitch."];
...
function checkAnswer(currentIndex) {
  ...
  if (gamePattern[currentIndex] === userClickedPattern[currentIndex]) {
    ...
    $("#level-title").text(vulgs[randomNumber]);
    $("#level-subtitle").text("Press Any Key to Restart");
    setTimeout (function () {
